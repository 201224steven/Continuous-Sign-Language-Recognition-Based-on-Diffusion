...
def csv2dict(anno_path, dataset_type):
    ...
    info_dict = dict()
    # print('prefix: ', anno_path.rsplit("/", 3)[0] + "/features/fullFrame-210x260px")  # ../dataset/phoenix2014-T/features/fullFrame-210x260px
    ...
    for file_idx, file_info in tqdm(enumerate(inputs_list), total=len(inputs_list)):
        ...
        # print(video)
        path1, file = os.path.split(video)
        path2, dir = os.path.split(path1)
        video = os.path.join(path2, file)
...
if __name__ == '__main__':
    ...
    for md in mode:
        ...
        # print('note: ', args.annotation_prefix.format(md))  # ../dataset/phoenix2014-T/annotations/manual/PHOENIX-2014-T.{}.corpus.csv
